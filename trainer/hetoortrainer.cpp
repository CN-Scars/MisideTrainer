...
{
    // 地址：GameAssembly.dll + 0x507C78, 补丁字节：NOP x5
    uintptr_t patchAddress = moduleBase + 0x507C78;
...
{
    // 地址：GameAssembly.dll + 0x506F87, 补丁字节：NOP x5
    uintptr_t patchAddress = moduleBase + 0x506F87;
